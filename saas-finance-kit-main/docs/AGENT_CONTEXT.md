...
La plantilla original esta en:
`.claude/ai_templates/01-alt-action-stream.md`
...
- Plantillas AI: `.claude/ai_templates/`
- Para proyectos similares con tools reales, revisa la sección de `useActionStream.ts`
